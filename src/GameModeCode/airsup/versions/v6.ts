/**
 * Airsup_v6
 * Full Air Sup HUD version with mirrored scores, dynamic bars, and live objective ownership icons.
 *
 * Overview:
 * - Adds neutral, friendly, and enemy objective-state stacks for A, B, and C.
 * - Keeps the v5 score/bar systems and expands HUD state management around them.
 *
 * Version Focus:
 * - Delivers the first complete score HUD plus objective-awareness package.
...
// Per-player registry of score widgets plus objective-state plates for live visibility updates.

/**
 * Airsup_v5
 * Dynamic score-bar version built on the authoritative score flow from v4.
 *
 * Overview:
 * - Extends the HUD with proportional score bars for friendly and enemy teams.
 * - Keeps score text and bar fill sizes synchronized from the same authoritative values.
 *
 * Version Focus:
 * - Adds at-a-glance momentum feedback without changing the underlying match rules.
...
// Per-player registry of score labels and bar fills that are resized/retitled during play.

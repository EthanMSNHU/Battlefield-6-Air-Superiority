/**
 * Airsup_v3
 * HUD layout expansion version with objective placeholder boxes and A/B/C labels.
 *
 * Overview:
 * - Builds on the v2 HUD by adding objective slot visuals and label structure.
 * - Keeps scoring and event logic stable while expanding the presentation layer.
 *
 * Version Focus:
 * - Establishes the objective HUD scaffold that later live ownership-state versions rely on.
...
// This lightweight tracking approach is enough until later versions move to widget-name maps.
